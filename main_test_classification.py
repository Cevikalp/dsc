...
def parse_args():
    ...
    parser.add_argument('--path', default='/home/mlcv/CevikalpPy/deep_simplex_classifier/Cifar100_Models/CIFAR100_ResNet18_lr0.000500_Nirvana_Expand50_Epoch200_Seed4_div1/best_checkpoint.pth', help='additional note to output folder')
